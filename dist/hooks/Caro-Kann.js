...
const playTartakower = (initialState) => {
    const BoardContext = (0, react_1.createContext)((0, createBoard_1.default)(initialState));
    function useBoard(selector) {
        const { getBoard, setBoard, subscribe } = (0, react_1.useContext)(BoardContext);
    ...
    const BoardProvider = ({ value, children }) => {
        return (0, jsx_runtime_1.jsx)(BoardContext.Provider, { value: (0, createBoard_1.default)(value), children: children });
    };
